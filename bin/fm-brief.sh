...
3. Use the native \`gh\` CLI for GitHub operations, \`glab\` or the existing GitLab integration for GitLab operations, and Ego Lite / \`ego-browser\` for browser automation and UI acceptance.
